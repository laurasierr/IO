...
function afficher2(variables,contraintes)
{
  ...
  // elimina del body los inputs de variables y restricciones
  ...
  // dibuja MAX y MIN para seleccionar 
  a.appendChild(document.createTextNode("Funcion Objetivo"));
  ...
  radio1.setAttribute('checked',''); // seleccionado por defecto MAX
...
/////////////////////////////////////////
  i=0;
  // pinta en el body las restricciones y sus respectivas disponibilidades
  while (i < contraintes)
  {
    var p = document.createElement('p');
    a.appendChild(p);
...
// nombre del boton : resolver
final.appendChild(document.createTextNode("Resolver"));
a.appendChild(final);
